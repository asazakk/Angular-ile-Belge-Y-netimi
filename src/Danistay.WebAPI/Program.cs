...
using Danistay.Application.Interfaces;
using Danistay.Application.Services;
using Danistay.Domain.Interfaces;
using Danistay.Infrastructure.Data;
using Danistay.Infrastructure.Repositories;
using Danistay.Infrastructure.Services;
...
builder.Services.AddDbContext<DanistayDbContext>(options =>
...
using (var scope = app.Services.CreateScope())
{
    try
    {
        var context = scope.ServiceProvider.GetRequiredService<DanistayDbContext>();
